# This code is derived from a IDEA-Research/Grounded-Segment-Anything licensed under the Apache License 2.0
# Original file: https://github.com/IDEA-Research/Grounded-Segment-Anything/blob/main/gradio_app.py
# For more information, see https://github.com/IDEA-Research/Grounded-Segment-Anything/blob/main/LICENSE
